...
# This configuration was migrated on 2020-08-17 at 03:19:58 from the following location: /opt/IBM/WebSphere/AppServer/profiles/AppSrv03
...
AdminConfig.create('JAASAuthData', GlobalSecurityVar, [['userId', 'db2inst1'], ['description', ''], ['password', whydah1Node04_db2_password_1], ['alias', 'whydah1Node04/db2']])
